                                 ...
                                 ITagger<HighlightWordTag>
{
    ...
    /// <summary>
    /// Clears all active highlights in the current view.
    /// </summary>
    ...
    /// <summary>
    /// Adds a highlight to the specified span.
    /// </summary>
    ...
    /// <summary>
    /// Adds a highlight to the specified position and length.
    /// </summary>
    ...
    /// <summary>
    /// Highlights the code block containing the specified position.
    /// </summary>
    /// <param name="position">The position within the code block to highlight.</param>
