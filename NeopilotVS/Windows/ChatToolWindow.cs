...
{
    private NeopilotVSPackage package;
    ...
    private async Task InitializeWebViewAsync()
    {
        ...
        package = NeopilotVSPackage.Instance;
        ...
        catch (Exception ex)
        {
            ...
            await VS.MessageBox.ShowErrorAsync(
                "Neopilot: Failed to initialize webview core enviroment",
        ...
        var model = new InfoBarModel(
            new[] { new InfoBarTextSpan("It looks like Neopilot Chat is taking too long to load, " +
    ...
    public async Task ReloadAsync()
    {
        ...
        catch (Exception ex)
        {
            ...
            await VS.MessageBox.ShowErrorAsync(
                "Neopilot: Failed to open the chat page",
    ...
    private string GetSetThemeScript()
    {
        ...
        return $@"
            ...
            body {{
                /* window background */
	            --neopilot-editor-background:               #{GetColor(CommonControlsColors.ComboBoxBackgroundBrushKey):x8};
	            --neopilot-editor-color:                    #{textColor:x8};
	            --neopilot-chat-background:                 #{GetColor(EnvironmentColors.ToolWindowBackgroundBrushKey):x8};
	            --neopilot-text-color:                      #{textColor:x8};

                 /* user message block */
                --neopilot-message-block-user-background:   #{GetColor(EnvironmentColors.VizSurfaceSteelBlueMediumBrushKey):x8};
                --neopilot-message-block-user-color:        #{textColor:x8};

                 /* bot message block */
	            --neopilot-message-block-bot-background:    #{GetColor(CommonControlsColors.ComboBoxBackgroundDisabledBrushKey):x8};
                --neopilot-message-block-bot-color:         #{textColor:x8};

                 /* textbox input */
	            --neopilot-input-background:                #{GetColor(CommonControlsColors.TextBoxBackgroundBrushKey):x8};
	            --neopilot-input-color:                     #{GetColor(CommonControlsColors.TextBoxTextBrushKey):x8};
	            --neopilot-input-placeholder:               #{GetColor(CommonControlsColors.TextBoxTextDisabledBrushKey):x8};

                /* hyperlink */
	            --neopilot-link-color:                      #{GetColor(EnvironmentColors.DiagReportLinkTextBrushKey):x8};
	            --neopilot-link-hover-color:                #{GetColor(EnvironmentColors.DiagReportLinkTextHoverColorKey):x8};
