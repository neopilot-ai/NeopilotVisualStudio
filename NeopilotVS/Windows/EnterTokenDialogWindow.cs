...
public partial class EnterTokenDialogWindowControl : UserControl
{
    ...
    {
        _ = NeopilotVSPackage.Instance.LanguageServer.SignInWithAuthTokenAsync(authTokenInput.Text);
    ...
    {
        SettingsPage settingsPage = NeopilotVSPackage.Instance.SettingsPage;

        string state = Guid.NewGuid().ToString();
        string portalUrl =
            settingsPage.EnterpriseMode ? settingsPage.PortalUrl : "https://neopilot-ai.github.io";
