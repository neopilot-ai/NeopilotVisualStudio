...
{
    internal const string DiffAdornmentLayerName = "NeopilotInlineDiffAdornment";
                                     ...
                                     IOleCommandTarget
{
    ...
    private void HostView_OnCaretPositionChanged(object sender, CaretPositionChangedEventArgs e)
    {
        ...
        if (position >= span.Start.Position && position <= span.End.Position)
        {
            ...
            {
                NeopilotVSPackage.Instance?.Log($"InlineDiffAdornment.HostView_OnCaretPositionChanged: {ex}");
            }
        }
    }
    ...
    private void Adornment_OnAccepted()
    {
        ...
        {
             NeopilotVSPackage.Instance?.Log($"InlineDiffAdornment.Adornment_OnAccepted: Data formatting failed {ex}");
        } // COMException
...
[Name("NeopilotInlineDiffViewProvider")]
[ContentType("code")]
[ContentType("html")]
[ContentType("HTMLX")]
[ContentType("Razor")]
[TextViewRole(PredefinedTextViewRoles.Document)]
internal class NeopilotInlineDiffViewProvider : ILineTransformSourceProvider
{
