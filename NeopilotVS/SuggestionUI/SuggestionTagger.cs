...
internal sealed class SuggestionTagger : ITagger<SuggestionTag>
{
    ...
    private InlineGreyTextTagger GetTagger()
    {
        ...
        {
            NeopilotVSPackage.Instance?.LogAsync($"GetTagger Error: {ex}");
        }
        return null;
    }
    ...
    public bool SetSuggestion(String newSuggestion, int caretPoint)
    {
        ...
        {
            NeopilotVSPackage.Instance?.LogAsync("Exception: " + ex.ToString());
            return false;
        }
    }
    ...
    private void LostFocus(object sender, EventArgs e)
    {
        ...
        {
            NeopilotVSPackage.Instance?.LogAsync($"LostFocus Error: {ex}");
        }
    }
    ...
    public SuggestionTagger(IWpfTextView view, ITextBuffer buffer)
    {
        ...
        this.view = view;
        this.adornmentLayer = view.GetAdornmentLayer("NeopilotAdornmentLayer");
    ...
    void BufferChanged(object sender, TextContentChangedEventArgs e)
    {
        ...
        {
            NeopilotVSPackage.Instance?.LogAsync($"BufferChanged Error: {ex}");
        }
    }
    ...
    private void OnSizeChanged(object sender, EventArgs e)
    {
        ...
        {
            NeopilotVSPackage.Instance?.LogAsync($"OnSizeChanged Error: {ex}");
        }
    }
    ...
    public bool CompleteText()
    {
        ...
        {
            NeopilotVSPackage.Instance?.LogAsync("Exception: " + e.ToString());
        }
    ...
    public void ClearSuggestion()
    {
        ...
        {
             NeopilotVSPackage.Instance?.LogAsync($"ClearSuggestion Error: {ex}");
        }
    }
